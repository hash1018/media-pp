...
pub use text_handle::CudaTextLayerHandle;
use text_handle::TextLayerState;
pub use video_handle::CudaVideoLayerHandle;
...
struct CompositorShared {
    ...
    /// [`CudaVideoCompositorHandle::set_frame_rate`] writes.
...
/// [`VideoFit`](video_layer::VideoFit) work: `Cover` needs cropping, which no CUDA filter in
