// D3d11WindowRenderer's YUV420P pixel shader — what a software decode gives,
// drawn straight from system memory: luma, Cb and Cr each uploaded into a
// single-channel texture of its own, the chroma ones at half size. Reuses
// present_bgra.hlsl's vs_main, as present_nv12.hlsl does.
